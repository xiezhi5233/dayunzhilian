/**
 * Created by 阿四儿 on 2017/4/25.
 */
window.onload=function () {
    var lb = document.getElementById('felb');
    var btnl = document.getElementById('btnl');
    var btnr = document.getElementById('btnr');
    var banner = document.getElementsByClassName('bannerbbb')[0];
    var btn = document.getElementsByClassName('btnxxx')[0];
